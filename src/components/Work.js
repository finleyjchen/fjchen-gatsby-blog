...
const Work = () => (
  <div>
    ...
    <div className="post">
      <h3><a href="https://calpoly.edu" className="post-link">
      ...
      <p className="text-muted">
        <IoMdHourglass />January 2019 – Present
            </p>

      <p>
        Student assistant frontend web developer for Cal Poly's Administration & Finance Department.</p>
    </div>
    <div className="post">
