...
class Lighthouse extends React.Component {
  render() {
    const siteTitle = 'Finley Chen - Lighthouse Atascadero'
    const siteDescription =
      'Lighthouse Atascadero is a non-profit organization.'
    ...
    return (
      <Layout location={this.props.location} title={siteTitle}>
        ...
        <div className="post">
          <h3>
            <a href="https://lighthouseatascadero.org" className="post-link">
